...
export default function Home() {
  return (
    <>
      <Head>
        <title>Wazan - Workout Tracker</title>
        <meta
          name="description"
        ...
        <div className="mx-auto max-w-screen-xl px-4 py-8 sm:py-12 sm:px-6 lg:px-8">
          <div className="sm:flex sm:items-center sm:justify-between">
            ...
            <div className="mt-4 flex flex-col gap-4 sm:mt-0 sm:flex-row sm:items-center">
              ...
              <Link href="/login">
                <button
                  className="block rounded-lg bg-black px-5 py-3 text-sm font-medium text-white border transition hover:bg-white hover:border-black hover:text-black focus:outline-none focus:ring"
                  type="button"
                >
                  Get Started
                </button>
